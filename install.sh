...
echo "     (可选) 指定 token:  python3 dashboard/server.py --auth-token YOUR_TOKEN"
echo "     不指定则自动生成随机 token，启动时输出到控制台"
echo "  3. 打开看板:          http://<your-ip>:19527"
echo "     输入控制台显示的 Auth Token 即可进入"
echo ""
